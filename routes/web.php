...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'middleware' => ['auth','is_admin']], function() {
    ...
    Route::post('/account/{id}', [UserController::class, 'update'])->name('admin.account.update');
     ...
     // Category
     Route::get('/useraccount', [useraccountController::class, 'index'])->name('admin.useraccount.index');
     Route::post('/useraccount/tabledata', [useraccountController::class, 'tabledata'])->name('admin.useraccount.tabledata');
     Route::get('/useraccount/add-new-useraccount', [useraccountController::class, 'create'])->name('admin.useraccount.create');
     Route::get('/useraccount/update-useraccount/{id}', [useraccountController::class, 'edit'])->name('admin.useraccount.edit');
     Route::post('/useraccount/store', [useraccountController::class, 'store'])->name('admin.useraccount.store');
     Route::post('/useraccount/update-useraccount/{id}', [useraccountController::class, 'update'])->name('admin.useraccount.update');
     Route::delete('/useraccount/delete/{id}', [useraccountController::class, 'destroy'])->name('admin.useraccount.destroy');
...
Route::group(['prefix'=>'frontend'],function(){
    Route::get('homepage',[FrontendController::class,'home'])->name('home.page');
    Route::get('aboutpage',[FrontendController::class,'about'])->name('about.page');
    Route::get('blog_singlepage',[FrontendController::class,'blog_single'])->name('blog_single.page');
    Route::get('blogpage',[FrontendController::class,'blog'])->name('blog.page');
    Route::get('casespage',[FrontendController::class,'cases'])->name('cases.page');
    Route::get('contactpage',[FrontendController::class,'contact'])->name('contact.page');
    Route::get('servicespage',[FrontendController::class,'services'])->name('services.page');
});
