...
<div class="menu-area">
    ...
    <nav class="menu">
        <ul>
            <!-- this ststement is for an admin -->
            @if(Auth::user()->role == 'Admin')
                <li class="ml-5 text-success"><h2>Admin</h2></li>
                <li><a class="{{ $pageName == 'Dashboard'? 'active' : '' }}"
                ...
                <li><a class="{{ $pageName == 'Brands'? 'active' : '' }}"
                        href="{{ route('admin.brand.index') }}"><svg
                    ...
                    <!-- sub-menu -->
                    <ul class="sub-menu">
                        <li><a class="{{ $pageName == 'Category'? 'active' : '' }}"
                                href="{{ route('admin.category.index') }}">Categories</a></li>
                        <li><a class="{{ $pageName == 'Subcategories'? 'active' : '' }}"
                                href="{{ route('admin.Subcategories.index') }}">sub_categories</a>
                        </li>
                        <li><a class="{{ $pageName == 'color'? 'active' : '' }}"
                                href="{{ route('admin.color.index') }}">Color</a></li>
                        <li><a class="{{ $pageName == 'size'? 'active' : '' }}"
                                href="{{ route('admin.size.index') }}">Size</a></li>
                        <li><a class="{{ $pageName == 'product'? 'active' : '' }}"
                                href="{{ route('admin.product.index') }}">Product</a></li>
                    </ul>
                    <!-- sub-menu -->
                </li>
                <!-- addedit user -->
                <li><a class="{{ $pageName == 'User'|| $pageName == 'Add User' || $pageName == 'Update User'? 'active' : '' }}"
                        href="{{ route('admin.useraccount.index') }}"><svg
                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <!-- account -->
                <li><a class="{{ $pageName == 'Subcategories' || $pageName == 'Add Subcategories' || $pageName == 'Update Subcategories' || $pageName == 'Category' || $pageName == 'Add Category' || $pageName == 'Update Category'? 'active' : '' }}"
                        href="javascript:;"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                fill="#63729A" />
                        </svg> <span class="hide-item">Subcategories </span> <span class="drop-icon"><i
                ...
                <li><a class="{{ $pageName == 'Page' || $pageName == 'Add Page' || $pageName == 'Update Page' || $pageName == 'Section' || $pageName == 'Add Section' || $pageName == 'Update Section' || $pageName == 'Faq' || $pageName == 'Add Faq' || $pageName == 'Update Faq' || $pageName == 'Gallery' || $pageName == 'Add Gallery' || $pageName == 'Update Gallery' || $pageName == 'Testimonial' || $pageName == 'Add Testimonial' || $pageName == 'Update Testimonial' || $pageName == 'Update Testimonial'? 'active' : '' }}"
                        href="javascript:;"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M12 3C7.03711 3 3 7.03711 3 12C3 16.9629 7.03711 21 12 21C16.9629 21 21 16.9629 21 12C21 7.03711 16.9629 3 12 3ZM12 4.5C13.4766 4.5 14.8477 4.93945 16.0078 5.67188L15.3984 5.74219L15.5391 7.24219L14.7422 6.89062L14.0859 7.45312L14.2031 9L15.8203 8.48438L17.8359 9.14062L17.3203 10.0781L16.1016 9.32812L14.7891 9.51562L13.5 10.4766L12.7734 12.7266L14.2266 13.9219C14.2266 13.9219 15.7178 13.6641 15.7969 13.6641C15.876 13.6641 16.4297 15.0234 16.4297 15.0234L15.2344 18.7734C14.2588 19.2393 13.1572 19.5 12 19.5C11.7627 19.5 11.5283 19.4736 11.2969 19.4531L10.4766 18.0234L11.2734 15.0234L8.25 12.75H5.46094L4.73438 11.2734L6.75 9.67969L9.75 8.25L9.30469 6.25781L10.5938 5.97656L11.2031 6.82031L13.4531 6.39844L13.0547 4.66406L11.3906 4.54688C11.5898 4.53223 11.7949 4.5 12 4.5ZM11.1562 4.54688L9.98438 5.03906L9.42188 4.94531C9.97559 4.74316 10.5498 4.61426 11.1562 4.54688ZM4.54688 12.5859L5.27344 13.4297V14.9766L6.67969 16.5234H7.54688L9.67969 19.1484C6.84961 18.2314 4.78418 15.668 4.54688 12.5859Z"
                                fill="#63729A" />
                        </svg> <span class="hide-item">School </span> <span class="drop-icon"><i class="fa fa-angle-down"
                                aria-hidden="true"></i></span></a>
                    <!-- sub-menu -->
                    <ul class="sub-menu">
                        <li><a class="{{ $pageName == 'Page'? 'active' : '' }}"
                                href="{{ route('admin.page.index') }}">Students</a></li>
                        <li><a class="{{ $pageName == 'Section'? 'active' : '' }}"
                                href="{{ route('admin.section.index') }}">Classes</a></li>
                        <li><a class="{{ $pageName == 'Faq'? 'active' : '' }}"
                                href="{{ route('admin.faq.index') }}">Subjects</a></li>
                        <li><a class="{{ $pageName == 'Review'? 'active' : '' }}"
                                href="{{ route('admin.testimonial.index') }}">Reviews</a></li>
                    </ul>
                    <!-- sub-menu -->
            ...
            <li class="ml-5 text-success"><h2>Parent</h2></li>
                <li><a href="{{ route('logout') }}"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                            height="24" viewbox="0 0 24 24" fill="none">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M12 3C7.03711 3 3 7.03711 3 12C3 16.9629 7.03711 21 12 21C15.0381 21 17.7305 19.4912 19.3594 17.1797L18.1406 16.3125C16.7842 18.2402 14.543 19.5 12 19.5C7.84863 19.5 4.5 16.1514 4.5 12C4.5 7.84863 7.84863 4.5 12 4.5C14.543 4.5 16.7812 5.75977 18.1406 7.6875L19.3594 6.82031C17.7305 4.50879 15.0381 3 12 3ZM17.5078 8.46094L16.4297 9.53906L18.1406 11.25H9V12.75H18.1406L16.4297 14.4609L17.5078 15.5391L20.5078 12.5391L21.0234 12L20.5078 11.4609L17.5078 8.46094Z"
            ...
            @if(Auth::user()->role == 'librarin')
                ...
                <li class="ml-5 text-success"><h2>Librarin</h2></li>
                <li><a href="{{ route('logout') }}"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                            height="24" viewbox="0 0 24 24" fill="none">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M12 3C7.03711 3 3 7.03711 3 12C3 16.9629 7.03711 21 12 21C15.0381 21 17.7305 19.4912 19.3594 17.1797L18.1406 16.3125C16.7842 18.2402 14.543 19.5 12 19.5C7.84863 19.5 4.5 16.1514 4.5 12C4.5 7.84863 7.84863 4.5 12 4.5C14.543 4.5 16.7812 5.75977 18.1406 7.6875L19.3594 6.82031C17.7305 4.50879 15.0381 3 12 3ZM17.5078 8.46094L16.4297 9.53906L18.1406 11.25H9V12.75H18.1406L16.4297 14.4609L17.5078 15.5391L20.5078 12.5391L21.0234 12L20.5078 11.4609L17.5078 8.46094Z"
            ...
            <li class="ml-5 text-success"><h2>Accountent</h2></li>
                <li><a href="{{ route('logout') }}"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                            height="24" viewbox="0 0 24 24" fill="none">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M12 3C7.03711 3 3 7.03711 3 12C3 16.9629 7.03711 21 12 21C15.0381 21 17.7305 19.4912 19.3594 17.1797L18.1406 16.3125C16.7842 18.2402 14.543 19.5 12 19.5C7.84863 19.5 4.5 16.1514 4.5 12C4.5 7.84863 7.84863 4.5 12 4.5C14.543 4.5 16.7812 5.75977 18.1406 7.6875L19.3594 6.82031C17.7305 4.50879 15.0381 3 12 3ZM17.5078 8.46094L16.4297 9.53906L18.1406 11.25H9V12.75H18.1406L16.4297 14.4609L17.5078 15.5391L20.5078 12.5391L21.0234 12L20.5078 11.4609L17.5078 8.46094Z"
                ...
                <li><a class="{{ $pageName == 'Update Settings'? 'active' : '' }}"
                        href="{{ route('admin.setting.edit', ['id' => 1]) }}"><svg
                            ...
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M17.9297 2.97656C17.1445 2.97656 16.3594 3.28125 15.75 3.89062L3.89062 15.75L3.84375 15.9844L3.02344 20.1094L2.78906 21.2109L3.89062 20.9766L8.01562 20.1562L8.25 20.1094L20.1094 8.25C21.3281 7.03125 21.3281 5.10938 20.1094 3.89062C19.5 3.28125 18.7148 2.97656 17.9297 2.97656ZM17.9297 4.40625C18.3076 4.40625 18.6885 4.5791 19.0547 4.94531C19.7842 5.6748 19.7842 6.46582 19.0547 7.19531L18.5156 7.71094L16.2891 5.48438L16.8047 4.94531C17.1709 4.5791 17.5518 4.40625 17.9297 4.40625ZM15.2344 6.53906L17.4609 8.76562L8.39062 17.8359C7.89844 16.875 7.125 16.1016 6.16406 15.6094L15.2344 6.53906ZM5.20312 16.8281C6.10254 17.1914 6.80859 17.8975 7.17188 18.7969L4.71094 19.2891L5.20312 16.8281Z"
                                fill="#63729A"></path>
                        </svg> <span class="hide-item">Subjects </span></a></li>
                <li><a class="{{ $pageName == 'Lead'? 'active' : '' }}"
                        href="{{ route('admin.lead.index') }}"><svg xmlns="http://www.w3.org/2000/svg"
                            width="24" height="24" viewbox="0 0 24 24" fill="none">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M3.75 3V4.75781L3.91406 4.96875L9.75 12.2578V21.0234L10.9453 20.0859L12.1172 19.1953C12.6789 21.9253 15.1088 24 18 24C21.3045 24 24 21.3045 24 18C24 14.6955 21.3045 12 18 12C16.5848 12 15.2782 12.5102 14.25 13.3359V12.2578L20.0859 4.96729L20.25 4.75781V3H3.75ZM5.46094 4.5H18.5391L13.1484 11.25H10.8516L5.46094 4.5ZM11.25 12.75H12.75V15.0938C12.366 15.7852 12.1089 16.5671 12.0234 17.3906L11.25 18V12.75ZM18 13.5C20.493 13.5 22.5 15.507 22.5 18C22.5 20.493 20.493 22.5 18 22.5C15.507 22.5 13.5 20.493 13.5 18C13.5 15.507 15.507 13.5 18 13.5ZM17.25 14.25V15.0469C16.4062 15.1879 15.75 15.9037 15.75 16.7827C15.75 17.3482 16.0633 17.8652 16.5703 18.1172L18.75 19.2188C18.75 19.386 18.636 19.5 18.4688 19.5H17.5312C17.364 19.5 17.25 19.386 17.25 19.2188V18.75H15.75V19.2188C15.75 20.0977 16.4062 20.8121 17.25 20.9531V21.75H18.75V20.9531C19.5938 20.8121 20.25 20.0963 20.25 19.2173C20.25 18.6518 19.9367 18.1378 19.4297 17.8828L17.25 16.7812C17.25 16.614 17.364 16.5 17.5312 16.5H18.4688C18.636 16.5 18.75 16.614 18.75 16.7812V17.25H20.25V16.7812C20.25 15.9023 19.5938 15.1879 18.75 15.0469V14.25H17.25Z"
                                fill="#63729A" />
                        </svg> <span class="hide-item">Classes </span></a></li>
                <li><a href="{{ route('logout') }}"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                            height="24" viewbox="0 0 24 24" fill="none">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M12 3C7.03711 3 3 7.03711 3 12C3 16.9629 7.03711 21 12 21C15.0381 21 17.7305 19.4912 19.3594 17.1797L18.1406 16.3125C16.7842 18.2402 14.543 19.5 12 19.5C7.84863 19.5 4.5 16.1514 4.5 12C4.5 7.84863 7.84863 4.5 12 4.5C14.543 4.5 16.7812 5.75977 18.1406 7.6875L19.3594 6.82031C17.7305 4.50879 15.0381 3 12 3ZM17.5078 8.46094L16.4297 9.53906L18.1406 11.25H9V12.75H18.1406L16.4297 14.4609L17.5078 15.5391L20.5078 12.5391L21.0234 12L20.5078 11.4609L17.5078 8.46094Z"
